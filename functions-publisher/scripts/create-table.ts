...
async function runTableOperations(instanceID: any, tableID: any) {
...
async function deleteTable(instanceID: any, tableID: any) {
...
require('yargs')
  ...
  .command(
    ...
    {},
    (argv: any) => runTableOperations(argv.instance, argv.table)
  )
  .example(
  ...
  .wrap(120)
  .command('delete', 'Delete table.', {}, (argv: any) =>
