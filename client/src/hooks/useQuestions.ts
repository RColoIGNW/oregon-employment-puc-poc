...
const _questions: QuestionModel[] = [
  ...
  },
  {
    code: "C_2",
    text:
      "Did you apply for or receive, or would you be eligible to receive if you had ever applied for",
    showOptions: false,
    whenShowDetails: "NEVER",
  ...
  },
  {
    code: "C_3",
    text:
      "Have you been diagnosed with COVID–19 or are you experiencing symptoms of COVID–19 and seeking a medical diagnosis?",
    showOptions: true,
    note:
  ...
  },
  {
    code: "C_5",
    text:
      "Are you caring for a family member or a member of your household who has been diagnosed with COVID–19?",
    showOptions: true,
    note: 'If "YES", please enter the date the household member was diagnosed.',
    whenShowDetails: "YES",
    whenShowSubQuestions: "NEVER",
  ...
  },
  {
    code: "C_6",
    text:
      "Is there a child or other person in the household for which you have primary caregiving responsibility that is unable to attend school or another facility that is closed as a direct result of the COVID-19 public health emergency and such school or facility care is required?",
    showOptions: true,
    note:
  ...
  },
  {
    code: "C_7",
    text:
      "Have you become the breadwinner or provider of major support for a household because the head of the household has died as a direct result of COVID–19?",
    showOptions: true,
    note:
  ...
  },
  {
    code: "C_8",
    text:
      "Has your place of employment closed as a direct result of the COVID–19 public health emergency?",
    showOptions: true,
    note:
  ...
  },
  {
    code: "C_10",
    text:
      "Were you scheduled to start a new job that has since closed as a direct result of the COVID-19 public health emergency?",
    showOptions: true,
    note:
      'If "YES", please enter the date you were expected to start work, the date your new job closed, and the name of the business.',
    whenShowDetails: "YES",
    whenShowSubQuestions: "NEVER",
    answer: {
      questionCode: "C_10",
  ...
  },
  {
    code: "C_11",
    text:
      "Are you unable to reach your place of employment because you have been advised by a health care provider to self-quarantine due to concerns related to COVID–19?",
    showOptions: true,
    note:
      'If "YES", please enter the reason why you are unable to reach your place of employment and the date this began.',
    whenShowDetails: "YES",
    whenShowSubQuestions: "NEVER",
    answer: {
      questionCode: "C_11",
  ...
  },
  {
    code: "C_12",
    text:
      "Are you unable to reach your place of employment because of a quarantine imposed as a direct result of the COVID-19 public health emergency?",
    showOptions: true,
    note:
      'If "YES", please enter the reason why you are unable to reach your place of employment and the date this began.',
    whenShowDetails: "YES",
  ...
  },
  {
    code: "C_13",
    text:
      "Do you have the ability to continue to receive payment from your employer while working from home?",
    showOptions: true,
    note:
  ...
  },
  {
    ...
    showOptions: true,
    note:
      'If "YES", please enter the date you began to receive paid sick leave or paid leave benefits and who you are receiving this payment from, if you know an end date please include that.',
    whenShowDetails: "YES",
    whenShowSubQuestions: "NEVER",
    answer: {
      questionCode: "C_14",
  ...
  },
  {
    code: "E_1",
    text:
      "Do you choose to have 10% of your unemployment benefits withheld for federal income taxes?",
    showOptions: true,
    whenShowDetails: "NEVER",
    whenShowSubQuestions: "NEVER",
    answer: {
  ...
  },
  {
    code: "E_2",
    text:
      "Do you choose to have 6% of your unemployment benefits withheld for state income taxes?",
    showOptions: true,
    whenShowDetails: "NEVER",
    whenShowSubQuestions: "NEVER",
    answer: {
...
export default (answers: AnswerModel[]) => {
  const questions: QuestionModel[] = prepareQuestions(answers)
