...
export default (props: ApplicantInfoProps) => {
  ...
  const handleAddressChange = (address: Address) => {
    props.onChange({ ...applicant, address })
  }
          ...
          <FormControl component="fieldset">
            ...
            <RadioGroup>
              <FormControlLabel
                control={
                  <Radio
                    checked={applicant.contactMethod === ContactMethod.Phone}
              ...
              <FormControlLabel
                control={
                  <Radio
                    checked={applicant.contactMethod === ContactMethod.Email}
                    onChange={handleSelection}
                    name="contactMethod"
          ...
          <FormControl component="fieldset">
            ...
            <RadioGroup>
              <FormControlLabel
                control={
                  <Radio
                    checked={applicant.gender === Gender.Male}
                    onChange={handleSelection}
                    name="gender"
                    value={Gender.Male}
                    color="primary"
              ...
              <FormControlLabel
                control={
                  <Radio
                    checked={applicant.gender === Gender.Female}
                    onChange={handleSelection}
                    name="gender"
                    value={Gender.Female}
                    color="primary"
          ...
          <FormControl component="fieldset">
            ...
            <RadioGroup>
              <FormControlLabel
                control={
                  <Radio
                    checked={applicant.isHispanicLatino === true}
              ...
              <FormControlLabel
                control={
                  <Radio
                    checked={applicant.isHispanicLatino === false}
                    onChange={handleBooleanSelection}
                    name="isHispanicLatino"
                    value={false}
                    color="primary"
            ...
            <FormGroup>
              {Races.map((race) => (
                <FormControlLabel
                  ...
                  control={
                    <Checkbox
                      checked={!!applicant.races?.find((r) => r === race)}
