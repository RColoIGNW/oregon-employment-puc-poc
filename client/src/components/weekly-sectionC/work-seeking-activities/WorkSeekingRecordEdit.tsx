      ...
      <Dialog fullScreen={fullScreen} open={open} onClose={handleCancel}>
        ...
        <DialogContent>
          <Grid container spacing={2} direction="column">
            <Grid item xs={12}>
              <TextField fullWidth value={state.activity} name="activity" onChange={handleTextChange} label="Activity" variant="outlined" disabled={props.isDisabled} />
            </Grid>
            <Grid item xs={12}>
              <KeyboardDatePicker fullWidth value={state.date} onChange={handleDateChange} label="Date" format="MM/DD/YYYY" inputVariant="outlined" disabled={props.isDisabled} />
            </Grid>
          </Grid>
        </DialogContent>
        <DialogActions>
