...
return (
  <>
  <Grid container direction={'row'} justify={'flex-end'} spacing={0} style={{background: 'white'}}>
    <Grid item>      
      <IconButton 
      ...
      >
        <Tooltip title="Continue application">
          <EditIcon fontSize={'small'} color={!!props.disableEdit?'disabled':'primary'} />
          </Tooltip>
      </IconButton>
    </Grid>
    <Grid item>
      ...
      >
        <Tooltip title="Download application (PDF)">
          <SaveAltIcon fontSize={'small'} color={!!props.disableDownload?'disabled':'primary'} />
          </Tooltip>
      </IconButton>
    </Grid>
    <Grid item>      
      ...
      >
        <Tooltip title="Discard application">
          <DeleteIcon fontSize={'small'} color={!!props.disableDiscard?'disabled':'primary'}/>        
        </Tooltip>
      </IconButton>
    </Grid>
  </Grid>
