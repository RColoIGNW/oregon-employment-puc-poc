import { IQuestion, IAnswer } from "../components/question/question"

export default () => {
  const c_2_questions: IQuestion[]= [
    {
      code: 'C_2_1',
  ...
  const handleChange = (q: IAnswer) => {
    //TODO: UPDATE question Answer
  }
  const validate = (): {answers: IAnswer[], errors: string[]} => {
